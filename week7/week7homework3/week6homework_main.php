		...
		<script type = 'text/javascript'>
			document.addEventListener('DOMContentLoaded', function(){
				...
				$('form').submit(function(e){
					...
					$.ajax({
						type: 'POST',
						url: '/PHP/week6homework_posts.php',
						data: {
							comment: comment,
						},
								...
								$('.input_main_comment').after(`
									<div class = "main">
										<div class = 'information name_time main_coment_done modifydiv'>
											<p>${res.nickname}</p>
											<p><a href = '/PHP/week6homework_modifypage.php?id_main=${res.id_main}' class = 'modify'>編輯</a></p>
											<p><a href = '/PHP/week6homework_del.php?id_main=${res.id_main}' class = 'delete'>刪除</a></p>
											<p>${res.datetime}</p>
										</div>
